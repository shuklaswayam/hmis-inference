...
interface CommandDialogProps extends React.ComponentPropsWithoutRef<typeof Command> {
  open?: boolean
  ...
  return (
    <Dialog {...props}>
      <DialogContent className="overflow-hidden p-0 max-w-2xl">
        <Command className="[&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:text-overline [&_[cmdk-group-heading]]:text-muted-foreground [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group]]:px-1.5 [&_[cmdk-input-wrapper]_input]:h-12 [&_[cmdk-input-wrapper]_input]:text-body-lg [&_[cmdk-input-wrapper]_input]:font-normal">
          {children}
       </Command>
     </DialogContent>
   </Dialog>
...
>((props, ref) => (
  <CommandPrimitive.Empty
    ref={ref}
    className="py-6 text-center text-body-sm text-muted-foreground"
    {...props}
  />
))
